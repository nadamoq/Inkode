...
<head>
    <meta charset="utf-8" />
    <title>Inkode @yield('title')</title>
...
<body
        ...
        <div class="flex justify-between items-center max-w-max_width mx-auto px-gutter h-16">
                ...
                <a class="text-headline-md font-display font-extrabold text-primary tracking-tighter" href="#">
                    <div class="flex items-center gap-2">
                        <img alt="Inkode Logo" class="h-8 w-auto object-contain"
                            src="https://lh3.googleusercontent.com/aida/ADBb0ugbskC-kpM_WQUPYgN1zhe9D6BMcVv9Y7ObBHCC-k9aZ4jx_2kL5ToFY3-tOhraHJ4v6PP50B0vl2WfsH3X6_OoCvG-OmESTCRIgQnBqsa_Dw-NKDQtB9DzYcaxa2okxco6XFLkK2NCcl81ai8rq4emwygANbD-cSRBOMeWA0E7o3p-X8OO02qPDd8eFqD1gAnFnr9LTfuz8l7ti5I5h74Q3eJtinKhpeHvhQz4INj8DXBiu0zPNVhcXxDUmJWYuXJt2bCNDUmfZA" />
            ...
            <div class="flex items-center gap-md">
                ...
                <button
                    ...
                    <span class="block dark:hidden" id="theme-icon-light">dark_mode</span>
                </button>
                <button
    ...
    <main class="pt-24 pb-xl max-w-max_width mx-auto px-gutter @yield('main-class')">
        @yield('content')
    </main>
    <!-- Footer -->
    <footer
